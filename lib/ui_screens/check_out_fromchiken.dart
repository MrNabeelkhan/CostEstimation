import 'package:cost_explanation/ui_screens/widgets/app_bar.dart';
            ...
            Column(
              children: [
                Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(30),
                        border: Border.all(color: MyColors.mybcolor, width: 2)),
                ...
                Text(
                  imageName,
                  style: TextStyle(
                      color: MyColors.mywhcolor.withOpacity(0.5),
                      fontSize: 7,
                      fontFamily: 'Ubuntu'),
                )
              ],
